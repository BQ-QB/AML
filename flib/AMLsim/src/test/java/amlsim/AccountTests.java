...
class AccountTests {
        ...
        void SingleTransactionModelBenefitListZero() {
                ...
                try (MockedStatic<AMLSim> mocked = mockStatic(AMLSim.class)) {
                        ...
                        mocked.verify(() -> AMLSim.handleTransaction(1L, "TRANSFER", 3.0, anAccount, beneAccount, false,
                                        -1L, 1),
                                        never());
                }
        }
        ...
        public void SingleTransactionModelBenefitListExists() {
                ...
                try (MockedStatic<AMLSim> mocked = mockStatic(AMLSim.class);
                        ...
                        anAccount.handleAction(amlSim);
                        mocked.verify(() -> AMLSim.handleTransaction(1L, "TRANSFER", 41.00808114922017d, anAccount,
                                        beneAccount,
                                        false, -1L, 1), times(1));
                }
        }
